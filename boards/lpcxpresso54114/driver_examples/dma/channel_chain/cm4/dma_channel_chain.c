...
#define DEMO_DMA_CHANNEL_TRIGGER_INPUT kINPUTMUX_Otrig0ToDma
#define DEMO_DMA_CHANNEL_TRIGGER_OUTPUT0 kINPUTMUX_DmaFlexcomm0RxTrigoutToTriginChannels
#define DEMO_DMA_CHANNEL_TRIGGER_OUTPUT1 kINPUTMUX_DmaFlexcomm0TxTrigoutToTriginChannels
