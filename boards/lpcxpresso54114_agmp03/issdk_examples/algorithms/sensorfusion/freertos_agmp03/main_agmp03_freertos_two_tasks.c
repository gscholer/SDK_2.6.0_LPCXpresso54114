...
int main(void)
{
    ...
    sfg.installSensor(&sfg, &sensors[0], FXAS21002_I2C_ADDR, 1, (void *)I2Cdrv, &i2cBusInfo, FXAS21002_Init,
                      FXAS21002_Read);
    ...
    sfg.installSensor(&sfg, &sensors[3], FXLS8962_I2C_ADDR, 1, (void *)I2Cdrv, &i2cBusInfo, FXLS8962_Init,
                      FXLS8962_Read);
